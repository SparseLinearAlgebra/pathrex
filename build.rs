...
fn regenerate_bindings() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("GxB_Matrix_build_Scalar")
        .allowlist_type("GrB_Scalar")
        .allowlist_function("GrB_Scalar_new")
        .allowlist_function("GrB_Scalar_setElement_BOOL")
        .allowlist_function("GrB_Scalar_free")
